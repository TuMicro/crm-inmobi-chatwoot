 ...
 */
// [turuta] Filtros que un CRM de WhatsApp no usa: fuera de la lista.
const TURUTA_FILTROS_OCULTOS = new Set([
  CONVERSATION_ATTRIBUTES.PRIORITY,
  CONVERSATION_ATTRIBUTES.TEAM_ID,
  CONVERSATION_ATTRIBUTES.CAMPAIGN_ID,
  CONVERSATION_ATTRIBUTES.BROWSER_LANGUAGE,
  CONVERSATION_ATTRIBUTES.REFERER,
]);
...
export function useConversationFilterContext() {
  ...
  const filterTypes = computed(() =>
    ...
    ].filter(filtro => !TURUTA_FILTROS_OCULTOS.has(filtro.attributeKey))
  ); // [turuta]
